    ...
    <nav class="navbar navbar-default navbar-fixed-top topnav" role="navigation">
        <div class="container topnav">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand topnav" href="index.jsp"><img src="ogasys logo 120x40.svg"></a></a>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="intro-message">
                        <img src="logo.svg" style="height: 131px;margin-top: 50px;">
            ...
            <div class="modal-body row">
                ...
                <form class="col-md-10 col-md-offset-1 col-xs-12 col-xs-offset-0">
                    ...
                    <div class="form-group">
                        ...
                        <span class="pull-right"><a href="registration.jsp">Register</a></span><span><a href="#">Need help?</a></span>
                    </div>
                </form>
            </div>
