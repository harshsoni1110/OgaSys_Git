...
<head>
	...
	function checkAddress () {
		...
		var r_address = document.searchform.checkAddress;
		var t_box = document.getElementById("mydiv");
		if (r_address[0].checked) {
		...
		//function checkAddress() {
			//var x = document.getElementById("checkAddress");
			//alert (x.value);
/*            if (a == 'on' ) 
            {                              
...
<body onload="checkAddress()"  >
    ...
    <div class="intro-header" style="background : none;">
        <div class="container">
		<form name="searchform" action=${pageContext.request.contextPath}/one method="post">
                ...
                <div class="panel panel-primary" style="margin-top:20px; width:100%; margin-left:300px">
                    ...
                    <div class="panel-body">
                        ...
                        <label >
                        	<input type="radio" name="checkAddress" checked="checked" value="current" /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Use Current Location
                        </label>
                        	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <label>
                        	<input type="radio" name="checkAddress"  id="checkAddress" value="on"/>
                        	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Enter Address
                        </label>
                ...
                <div class="panel panel-primary" style="margin-top:20px; width:100%; margin-left:300px">
                    ...
                    <div class="panel-body">
                        ...
                        <label ><input type="radio" name="vtype" checked="checked" value="two" onChange="checkLocation()"/>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Two Wheelers</label>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <label ><input type="radio" name="vtype"  id="checkAddress" value="four" onChange="checkAddress()"/>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Four Wheelers</label>
                ...
                <div class="panel panel-primary" style="margin-top:20px; width:100%; margin-left:300px">
                    ...
                    <div class="panel-body">
                        ...
                        <label class="radio-inline"><input type="radio"  value="Basic" name="p1">&nbsp;&nbsp;&nbsp;Basic</label>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <label class="radio-inline"><input type="radio" value="Advance" name="p1">&nbsp;&nbsp;&nbsp;Advance</label>                    
                        </div>
            ...
            <!--div>
               ...
               <div style="float: left;margin-left: 450px;margin-top: 50px;">
                     <ul class="list-inline intro-social-buttons">
                            ...
                            <li>
                                <input type="submit" name="submit" value="Search Garage" class="btn btn-danger btn-lg btn-huge lato"/>Search Garages</span>
                            </li>
